	...
	const meshes = new Map<EMesh, IMesh>([
		[
			EMesh.wall_window,
			{
				...
				size: new Vector3(12.0, 12.0, 3.0),
		...
		[
			EMesh.fence_wood,
			{
				...
				size: new Vector3(1.218, 6.0, 1.5),
		...
		[
			EMesh.wall_corner_top1,
			{
				...
				size: new Vector3(12.0, 12.0, 12.0),
		...
		[
			EMesh.fence,
			{
				...
				size: new Vector3(12.009, 6.0, 1.5),
				key: EMesh.fence,
			},
		],
		[
		...
		[
			EMesh.wall_door1,
			{
				...
				size: new Vector3(12.0, 12.038, 3.0),
		...
		[
			EMesh.fence2,
			{
				...
				size: new Vector3(12.018, 6.0, 1.5),
				key: EMesh.fence2,
			},
		],
		[
		...
		[
			EMesh.wall1,
			{
				...
				size: new Vector3(12.0, 12.0, 0.001),
				key: EMesh.wall1,
			},
		],
		[
		...
		[
			EMesh.fence_edge,
			{
				...
				size: new Vector3(12.009, 6.0, 13.209),
		...
		[
			EMesh.railing_edge,
			{
				...
				size: new Vector3(12.0, 6.0, 12.0),
		...
		[
			EMesh.wall_door2,
			{
				...
				size: new Vector3(12.0, 12.038, 7.683),
		...
		[
			EMesh.key,
			{
				...
				size: new Vector3(2.635, 1.327, 0.23),
				key: EMesh.key,
			},
		],
		[
		...
		[
			EMesh.wall_corner4,
			{
				...
				size: new Vector3(12.0, 3.0, 12.0),
		...
		[
			EMesh.ground1,
			{
				...
				size: new Vector3(9.0, 0.001, 9.0),
				key: EMesh.ground1,
			},
		],
		[
		...
		[
			EMesh.ground,
			{
				...
				size: new Vector3(6.0, 0.001, 6.0),
				key: EMesh.ground,
			},
		],
		[
		...
		[
			EMesh.cone3,
			{
				...
				size: new Vector3(5.196, 6.0, 6.0),
				key: EMesh.cone3,
			},
		],
		[
		...
		[
			EMesh.torus,
			{
				...
				size: new Vector3(7.5, 1.299, 6.495),
				key: EMesh.torus,
			},
		],
		[
			EMesh.cylinder,
			{
				...
				size: new Vector3(5.196, 3.0, 6.0),
				key: EMesh.cylinder,
			},
		],
		[
		...
		[
			EMesh.cylinder4,
			{
				...
				size: new Vector3(5.196, 12.0, 6.0),
				key: EMesh.cylinder4,
			},
		],
		[
