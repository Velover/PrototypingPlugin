...
import ConvertMouseMoveToScale, {
	MouseMovedCallback,
} from "./convert_mouse_move_to_scale";
	...
	return (
		<viewportframe
			...
			Event={{
				...
				MouseMoved: ConvertMouseMoveToScale(
					CallRefference(mouse_move_callback),
				),
			}}
		/>
	);
