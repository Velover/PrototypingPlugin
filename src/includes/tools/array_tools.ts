...
export namespace ArrayTools {
  ...
  export function RemoveFromArray<T extends defined>(array: T[], check: (element: T) => boolean, stop_on_first: boolean = true) {
  ...
  export function Compare<T extends defined>(array_0: readonly T[], array_1: readonly T[], selector?: <Q extends defined>(array: readonly T[]) => Q) {
